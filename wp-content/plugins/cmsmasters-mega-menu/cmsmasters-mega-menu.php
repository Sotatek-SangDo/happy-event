...
class Cmsmasters_Mega_Menu { 
	function __construct() { 
		...
		load_plugin_textdomain('cmsmasters_mega_menu', false, dirname(plugin_basename(__FILE__)) . '/languages/');
	...
	public function cmsmasters_mega_menu_activation_compatibility() {
		if ( 
			...
			wp_die( 
				__("Your theme doesn't support CMSMasters Mega Menu plugin. Please use appropriate CMSMasters theme.", 'cmsmasters_mega_menu'), 
				__("Error!", 'cmsmasters_mega_menu'), 
				array( 
					'back_link' => 	true 
				) 
			);
	...
	public function cmsmasters_mega_menu_compatibility_warning() {
		echo "<div class=\"notice notice-warning is-dismissible\">
			<p><strong>" . __("CMSMasters Mega Menu plugin was deactivated, because your theme doesn't support it. Please use appropriate CMSMasters theme.", 'cmsmasters_mega_menu') . "</strong></p>
		</div>";
	}
}
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
			<dl class="menu-item-bar">
				<dt class="menu-item-handle">
					<span class="item-title"><span class="menu-item-title<?php echo $highlight_class . $icon_class . $hide_text_class; ?>"><?php echo esc_html( $title ); ?></span> <span class="is-submenu" <?php echo $submenu_text; ?>><?php _e( 'sub item' ); ?></span><span class="is-mega-menu" <?php echo $mega_menu_text; ?>><?php _e( 'mega menu', 'cmsmasters_mega_menu' ); ?></span><span class="is-column"><?php _e( 'column', 'cmsmasters_mega_menu' ); ?></span><span class="is-mega-descr-text"><?php _e( 'text block', 'cmsmasters_mega_menu' ); ?></span><span class="is-drop-side-right dashicons dashicons-arrow-left-alt" <?php echo $drop_side_text; ?>></span></span>
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="field-tag description description-thin">
					<label for="edit-menu-item-tag-<?php echo $item_id; ?>">
						<?php _e( 'Navigation Label Tag', 'cmsmasters_mega_menu' ); ?><br />
				...
				<p class="field-subtitle description description-thin">
					<label for="edit-menu-item-subtitle-<?php echo $item_id; ?>">
						<?php _e( 'Navigation Label Subtitle', 'cmsmasters_mega_menu' ); ?><br />
				...
				<p class="field-color description description-thin">
					<label for="edit-menu-item-color-<?php echo $item_id; ?>">
						<?php _e( 'Menu Item Color', 'cmsmasters_mega_menu' ); ?><br />
				...
				<p class="field-icon description description-thin">
					<label for="edit-menu-item-icon-<?php echo $item_id; ?>">
						<?php _e( 'Menu Item Icon', 'cmsmasters_mega_menu' ); ?><br />
						...
						<input id="edit-menu-item-icon-<?php echo $item_id; ?>_button" class="cmsmasters_icon_choose_button button button-small" type="button" value="<?php _e( 'Choose icon', 'cmsmasters_mega_menu' ); ?>" />
						<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="<?php _e( 'Remove icon', 'cmsmasters_mega_menu' ); ?>"<?php echo ((esc_attr($item->icon) != '') ? ' style="display:inline-block;"' : ''); ?>></a>
					</label>
				</p>
				<p class="field-highlight description description-thin description-wafer-thin">
					<label for="edit-menu-item-highlight-<?php echo $item_id; ?>">
						...
						<?php _e( 'Highlight', 'cmsmasters_mega_menu' ); ?>
					</label>
				</p>
				<p class="field-hide_text description description-thin description-wafer-thin">
					<label for="edit-menu-item-hide_text-<?php echo $item_id; ?>">
						...
						<?php _e( 'Hide Text', 'cmsmasters_mega_menu' ); ?>
					</label>
				</p>
				<p class="field-drop_side description description-wide">
					<label for="edit-menu-item-drop_side-<?php echo $item_id; ?>">
						...
						<?php _e( 'Align drop-down menus to the Right Side', 'cmsmasters_mega_menu' ); ?>
					</label>
				</p>
				...
				<p class="field-mega_cols description description-thin">
					<label for="edit-menu-item-mega_cols-<?php echo $item_id; ?>">
						...
						<select id="edit-menu-item-mega_cols-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_cols" name="menu-item-mega_cols[<?php echo $item_id; ?>]">
							<option value="two"<?php selected( $item->mega_cols, 'two' ); ?>><?php _e( '2 Columns', 'cmsmasters_mega_menu' ); ?></option>
							<option value="three"<?php selected( $item->mega_cols, 'three' ); ?>><?php _e( '3 Columns', 'cmsmasters_mega_menu' ); ?></option>
							<option value="four"<?php selected( $item->mega_cols, 'four' ); ?>><?php _e( '4 Columns', 'cmsmasters_mega_menu' ); ?></option>
							<option value="five"<?php selected( $item->mega_cols, 'five' ); ?>><?php _e( '5 Columns', 'cmsmasters_mega_menu' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-mega_cols_full description description-wide">
					<label for="edit-menu-item-mega_cols_full-<?php echo $item_id; ?>">
						...
						<?php _e( 'Stretch Mega Menu columns on full width', 'cmsmasters_mega_menu' ); ?>
					</label>
				</p>
				<p class="field-mega_bg_img description description-wide">
					...
					<label for="edit-menu-item-mega_bg_img-<?php echo $item_id; ?>" class="cmsmasters_upload_parent cmsmasters_select_parent">
						<?php _e( 'Mega Menu Background Image', 'cmsmasters_mega_menu' ); ?><br />
						<input type="button" id="cmsmasters_upload_<?php echo $item_id; ?>_button" class="cmsmasters_upload_button button button-small" value="<?php _e('Choose image', 'cmsmasters_mega_menu'); ?>" data-title="<?php _e('Choose image', 'cmsmasters_mega_menu'); ?>" data-button="<?php _e('Insert image', 'cmsmasters_mega_menu'); ?>" data-id="cmsmasters-media-select-frame-<?php echo $item_id; ?>" data-classes="media-frame cmsmasters-media-select-frame cmsmasters-frame-no-description cmsmasters-frame-no-caption cmsmasters-frame-no-align cmsmasters-frame-no-link" data-library="image" data-type="select" data-multiple="false" />
				...
				<p class="field-mega_bg_pos description description-thin description-narrow">
					<label for="edit-menu-item-mega_bg_pos-<?php echo $item_id; ?>">
						<?php _e( 'Background Position', 'cmsmasters_mega_menu' ); ?><br />
						<select id="edit-menu-item-mega_bg_pos-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_bg_pos" name="menu-item-mega_bg_pos[<?php echo $item_id; ?>]">
							<option value="top left"<?php selected( $item->mega_bg_pos, 'top left' ); ?>><?php _e( 'Top Left', 'cmsmasters_mega_menu' ); ?></option>
							<option value="top center"<?php selected( $item->mega_bg_pos, 'top center' ); ?>><?php _e( 'Top Center', 'cmsmasters_mega_menu' ); ?></option>
							<option value="top right"<?php selected( $item->mega_bg_pos, 'top right' ); ?>><?php _e( 'Top Right', 'cmsmasters_mega_menu' ); ?></option>
							<option value="center left"<?php selected( $item->mega_bg_pos, 'center left' ); ?>><?php _e( 'Center Left', 'cmsmasters_mega_menu' ); ?></option>
							<option value="center center"<?php selected( $item->mega_bg_pos, 'center center' ); ?>><?php _e( 'Center Center', 'cmsmasters_mega_menu' ); ?></option>
							<option value="center right"<?php selected( $item->mega_bg_pos, 'center right' ); ?>><?php _e( 'Center Right', 'cmsmasters_mega_menu' ); ?></option>
							<option value="bottom left"<?php selected( $item->mega_bg_pos, 'bottom left' ); ?>><?php _e( 'Bottom Left', 'cmsmasters_mega_menu' ); ?></option>
							<option value="bottom center"<?php selected( $item->mega_bg_pos, 'bottom center' ); ?>><?php _e( 'Bottom Center', 'cmsmasters_mega_menu' ); ?></option>
							<option value="bottom right"<?php selected( $item->mega_bg_pos, 'bottom right' ); ?>><?php _e( 'Bottom Right', 'cmsmasters_mega_menu' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-mega_bg_rep description description-thin description-narrow">
					<label for="edit-menu-item-mega_bg_rep-<?php echo $item_id; ?>">
						<?php _e( 'Background Repeat', 'cmsmasters_mega_menu' ); ?><br />
						<select id="edit-menu-item-mega_bg_rep-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_bg_rep" name="menu-item-mega_bg_rep[<?php echo $item_id; ?>]">
							<option value="no-repeat"<?php selected( $item->mega_bg_rep, 'no-repeat' ); ?>><?php _e( 'No Repeat', 'cmsmasters_mega_menu' ); ?></option>
							<option value="repeat-x"<?php selected( $item->mega_bg_rep, 'repeat-x' ); ?>><?php _e( 'Repeat Horizontally', 'cmsmasters_mega_menu' ); ?></option>
							<option value="repeat-y"<?php selected( $item->mega_bg_rep, 'repeat-y' ); ?>><?php _e( 'Repeat Vertically', 'cmsmasters_mega_menu' ); ?></option>
							<option value="repeat"<?php selected( $item->mega_bg_rep, 'repeat' ); ?>><?php _e( 'Repeat', 'cmsmasters_mega_menu' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-mega_bg_size description description-thin description-narrow">
					<label for="edit-menu-item-mega_bg_size-<?php echo $item_id; ?>">
						<?php _e( 'Background Size', 'cmsmasters_mega_menu' ); ?><br />
						<select id="edit-menu-item-mega_bg_size-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_bg_size" name="menu-item-mega_bg_size[<?php echo $item_id; ?>]">
							<option value="auto"<?php selected( $item->mega_bg_size, 'auto' ); ?>><?php _e( 'Auto', 'cmsmasters_mega_menu' ); ?></option>
							<option value="cover"<?php selected( $item->mega_bg_size, 'cover' ); ?>><?php _e( 'Cover', 'cmsmasters_mega_menu' ); ?></option>
							<option value="contain"<?php selected( $item->mega_bg_size, 'contain' ); ?>><?php _e( 'Contain', 'cmsmasters_mega_menu' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-mega_descr_text description description-wide">
					<label for="edit-menu-item-mega_descr_text-<?php echo $item_id; ?>">
						...
						<?php echo __( 'Use the description field to create a Text Block.', 'cmsmasters_mega_menu' ) . '<br />' . __( "Note: Don't remove the navigation label text, otherwise wordpress will delete the item", 'cmsmasters_mega_menu' ); ?>
					</label>
				</p>
