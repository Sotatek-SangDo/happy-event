...
for (var id in cmsmastersShortcodes) {
	if (id === 'cmsmasters_sidebar') {
		...
		/* Service Search */
		cmsmastersShortcodes_new_shortcode['cmsmasters_service_search'] = { 
			title : 	composer_shortcodes_extend.service_search_title, 
			icon : 		'admin-icon-service-search', 
			pair : 		false, 
			content : 	false, 
			visual : 	false, 
			multiple : 	false, 
			...
			fields : { 
				...
				keywords_text : { 
					type : 		'input', 
					title : 	composer_shortcodes_extend.service_search_keywords_title, 
					descr : 	composer_shortcodes_extend.service_search_keywords_descr, 
					def : 		composer_shortcodes_extend.service_search_keywords, 
					required : 	false, 
					width : 	'half' 
				}, 
				// Category Text
				category_text : { 
					type : 		'input', 
					title : 	composer_shortcodes_extend.service_search_category_title, 
					descr : 	composer_shortcodes_extend.service_search_category_descr, 
					def : 		composer_shortcodes_extend.service_search_category, 
					required : 	false, 
					width : 	'half' 
				}, 
				// Min Text
				min_text : { 
					type : 		'input', 
					title : 	composer_shortcodes_extend.service_search_min_title, 
					descr : 	composer_shortcodes_extend.service_search_min_descr, 
					def : 		composer_shortcodes_extend.service_search_min, 
					required : 	false, 
					width : 	'half' 
				}, 
				// Max Text
				max_text : { 
					type : 		'input', 
					title : 	composer_shortcodes_extend.service_search_max_title, 
					descr : 	composer_shortcodes_extend.service_search_max_descr, 
					def : 		composer_shortcodes_extend.service_search_max, 
					required : 	false, 
					width : 	'half' 
				}, 
				// Button Text
				button_text : { 
					type : 		'input', 
					title : 	composer_shortcodes_extend.service_search_button_title, 
					descr : 	composer_shortcodes_extend.service_search_button_descr, 
					def : 		composer_shortcodes_extend.service_search_button, 
					required : 	false, 
					width : 	'half' 
				}, 
				// CSS3 Animation
