...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'happy-events');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'happy-events');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'happy-events');
