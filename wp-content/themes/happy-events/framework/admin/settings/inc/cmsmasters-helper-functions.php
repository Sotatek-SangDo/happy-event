...
function happy_events_get_admin_page() {
	global $pagenow;
...
function happy_events_default_tab() {
	$current_page = happy_events_get_admin_page();
...
function happy_events_get_the_tab() {
	global $pagenow;
	
	$default_tab = happy_events_default_tab();
...
function happy_events_settings_page_header() {
