...
if (!function_exists('happy_events_get_custom_post_meta_fields')) {
function happy_events_get_custom_post_meta_fields() {
	$cmsmasters_option = happy_events_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['happy-events' . '_blog_post_layout']) && $cmsmasters_option['happy-events' . '_blog_post_layout'] !== '') ? $cmsmasters_option['happy-events' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['happy-events' . '_blog_post_title']) && $cmsmasters_option['happy-events' . '_blog_post_title'] !== '') ? (($cmsmasters_option['happy-events' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['happy-events' . '_blog_post_share_box']) && $cmsmasters_option['happy-events' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['happy-events' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['happy-events' . '_blog_post_author_box']) && $cmsmasters_option['happy-events' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['happy-events' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['happy-events' . '_blog_more_posts_box'])) ? $cmsmasters_option['happy-events' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'happy-events'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'happy-events'), 
			'desc'	=> esc_html__('Don\'t Show', 'happy-events'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'happy-events'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'happy-events'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'happy-events'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'happy-events') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
