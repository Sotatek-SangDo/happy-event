...
if (!function_exists('happy_events_get_custom_profile_meta_fields')) {
function happy_events_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['happy-events' . '_profile_post_title']) && $cmsmasters_option['happy-events' . '_profile_post_title'] !== '') ? (($cmsmasters_option['happy-events' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['happy-events' . '_profile_post_details_title']) && $cmsmasters_option['happy-events' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['happy-events' . '_profile_post_details_title'] : esc_html__('Profile details', 'happy-events');
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['happy-events' . '_profile_post_share_box']) && $cmsmasters_option['happy-events' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['happy-events' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'happy-events'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'happy-events'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'happy-events'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'happy-events'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'happy-events'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'happy-events'), 
			'desc'	=> '', 
