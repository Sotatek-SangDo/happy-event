...
function happy_events_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_profile .cmsmasters_profile_header .cmsmasters_profile_subtitle,
	...
	{$rule}.cmsmasters_dynamic_cart .cart_list a:not([class]):hover,
	...
	{$rule}.cmsmasters_archive_type .cmsmasters_archive_item_service_price,
	...
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['happy-events' . '_' . $scheme . '_link']) . ", .95);
	}
	...
	{$rule}.cmsmasters_single_slider_item_service .cmsmasters_single_slider_item_title a:hover, 
	...
	{$rule}.cmsmasters_single_slider_item_service_price,
	...
	{$rule}.cmsmasters_single_slider_item_service .cmsmasters_single_slider_item_inner_meta span, 
	...
	{$rule}.cmsmasters_dynamic_cart .cart_list a:not([class]),
	{$rule}.cmsmasters_added_product_info .cmsmasters_added_product_info_text,
	{$rule}.project_navi span,
	{$rule}.project_navi a {
	...
	{$rule}.cmsmasters_open_post .cmsmasters_post_cont_wrap .wp-caption {
	...
	{$rule}.cmsmasters_dynamic_cart .widget_shopping_cart_content:before {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['happy-events' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.cmsmasters_single_slider_item_service_icon, 
	{$rule}.cmsmasters_single_slider_item_service_price, 
	{$rule}.cmsmasters_single_slider_item_service .cmsmasters_single_slider_item_title a, 
	...
	{$rule}.cmsmasters_toggles .cmsmasters_toggle_arrow:before,
	{$rule}.cmsmasters_toggles .cmsmasters_toggle_arrow:after,
	...
	{$rule}.cmsmasters_quote_image img {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['happy-events' . '_' . $scheme . '_additional']) . "
	}
	
	{$rule}.cmsmasters_dynamic_cart .widget_shopping_cart_content:after  {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['happy-events' . '_' . $scheme . '_additional']) . "
	}
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['happy-events' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['happy-events' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['happy-events' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['happy-events' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('happy_events_theme_colors_primary_filter', $custom_css);
}
