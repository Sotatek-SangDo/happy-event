...
function happy_events_mytheme_comment($comment, $args, $depth) {
			...
			<div class="comment-content cmsmasters_comment_item_cont">
				<div class="cmsmasters_comment_item_cont_info">
					...
					comment_reply_link(array_merge($args, array( 
						...
						'reply_text' => esc_attr__('Reply', 'happy-events') 
					)));
					
					
					edit_comment_link(esc_attr__('Edit', 'happy-events'), '', '');
				...
				<div class="cmsmasters_comment_item_content">
					...
					if ($comment->comment_approved == '0') {
						echo '<p>' . 
							'<em>' . esc_html__('Your comment is awaiting moderation.', 'happy-events') . '</em>' . 
						'</p>';
					}
					?>
				</div>
